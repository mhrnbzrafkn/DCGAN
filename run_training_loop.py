...
from utils import report_training_process, save_models, weights_init
from models.discriminator import linear_Discriminator
...
def train_loop(losses, images_for_gif):
    ...
    discriminator = linear_Discriminator(OUTPUT_IMAGE_SHAPE)
    ...
    for epoch in range(EPOCHS):
        for i, (images, _) in enumerate(data_loader):
            ...
            print(f"[Epoch {epoch + 1:=4d}/{EPOCHS}] [Batch {i + 1:=4d}/{len(data_loader)}] ---> "
