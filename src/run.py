...
class Discriminator(nn.Module):
    def __init__(self, output_img_shape):
        ...
        self.conv1 = nn.Conv2d(in_channels=output_img_shape[0], out_channels=128, kernel_size=4, stride=2, padding=1, bias=False)
        ...
        self.conv5 = nn.Conv2d(in_channels=1024, out_channels=1, kernel_size=4, stride=1, padding=0, bias=False)
